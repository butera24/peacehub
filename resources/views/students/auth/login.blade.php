                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form method="POST" action="{{ route('user login') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="text-center pt-1 mb-5 pb-1">
                                            <button type="submit" class="btn btn-register btn-block " style="background-color: rgb(70, 70, 240)">SignIn</button>
                                            <p class="text-muted mt-3">Already have an account? <a href="{{ route('student.create') }}">Register</a></p>
                                        </div>
                                    </form>
                                </div>
                            </div>
