        ...
        <div class="right-section">
            ...
            <div class="row-2">
                    ...
                    <div class="img">
                        <div class="img">
                            ...
                            <!DOCTYPE svg
                                ...
                                enable-background="new 0 0 512 512" height="30px" id="Privacy" version="1.1"
                                viewBox="0 0 512 512" width="30px" xml:space="preserve"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <linearGradient gradientUnits="userSpaceOnUse" id="SVGID_1_" x1="135.103"
                                    x2="376.8968" y1="471" y2="229.2062">
                                    <stop offset="0" style="stop-color:#FF7BAC" />
                                    <stop offset="1" style="stop-color:#00FFFF" />
                                </linearGradient>
                                <path
                                    d="M371.994,461.68H140.007c-18.966,0-34.34-15.375-34.34-34.34V272.867  c0-18.966,15.374-34.34,34.34-34.34h231.987c18.965,0,34.339,15.375,34.339,34.34V427.34  C406.333,446.305,390.959,461.68,371.994,461.68z"
                                    fill="url(#SVGID_1_)" />
                                <path
                                    d="M377.521,224.297h-40v-53.116c0-44.587-36.274-80.861-80.86-80.861c-44.587,0-80.861,36.274-80.861,80.861  v53.116h-40v-53.116c0-66.643,54.218-120.861,120.861-120.861c66.643,0,120.86,54.218,120.86,120.861V224.297z"
                                    fill="#3F5EAB" />
                                <path
                                    d="M291,327.844c0-19.33-15.67-35-35-35s-35,15.67-35,35c0,10.8,4.895,20.453,12.582,26.873l-11.732,41.986  h68.01l-11.677-41.788C286.007,348.496,291,338.754,291,327.844z"
                                    fill="#3F5EAB" />
                            </svg>
                        </div>
                    </div>
                ...
                <div class="feature-card community">
                    <div class="img">
                        <?xml version="1.0" ?><svg height="30px" id="svg8" version="1.1" viewBox="0 0 24 24"
                            width="30px" xmlns="http://www.w3.org/2000/svg"
                            xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/"
                            xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <defs id="defs2">
                                <rect height="20px" id="rect2504" width="20px" x="-1.1008456" y="289.81766" />
                            </defs>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header border-bottom-0">
                    <div class="d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24" height="24"
                            fill="black" class="mr-2">
                            <path
                                d="M288 167.2v-28.1c-28.2-36.3-47.1-79.3-54.1-125.2-2.1-13.5-19-18.8-27.8-8.3-21.1 24.9-37.7 54.1-48.9 86.5 34.2 38.3 80 64.6 130.8 75.1zM400 64c-44.2 0-80 35.9-80 80.1v59.4C215.6 197.3 127 133 87 41.8c-5.5-12.5-23.2-13.2-29-.9C41.4 76 32 115.2 32 156.6c0 70.8 34.1 136.9 85.1 185.9 13.2 12.7 26.1 23.2 38.9 32.8l-143.9 36C1.4 414-3.4 426.4 2.6 435.7 20 462.6 63 508.2 155.8 512c8 .3 16-2.6 22.1-7.9l65.2-56.1H320c88.4 0 160-71.5 160-159.9V128l32-64H400zm0 96.1c-8.8 0-16-7.2-16-16s7.2-16 16-16 16 7.2 16 16-7.2 16-16 16z" />
                        </svg>
                        <h5 class="modal-title mb-0">PEACEHUB SIGNIN</h5>
                    </div>
                ...
                <div class="modal-footer border-top-0 d-flex justify-content-between">
                    ...
                    <a href="{{ route('student.create') }}" class="btn btn-link">Register</a>
                </div>
            </div>
        </div>
    </div>
